...
<main>
    <div class="tab-panel">
        <!--タブ-->
        <ul class="tab-group">
            <a href="./index.php"><li id="tabA" class="tab tab-A"><a href="./index.php">企業一覧</a></li>
            <li class="tab tab-B">企業情報追加</li>
            <li class="tab tab-C is-active">企業情報変更</li>
        </ul>
        <!--タブを切り替えて表示するコンテンツ-->
        <div class="panel-group">
            ...
            <div class="panel tab-C is-show">Content-C</div>
        </div>
</body>